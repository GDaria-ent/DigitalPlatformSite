...
<template>
    <div class='w-full h-full backdrop-filter backdrop-blur-md backdrop-contrast-100 w-screen h-screen overflow-y-auto'>
        <div class='popup-container mx-auto flex flex-col justify-center items-center mt-12 ml-6 mr-6 py-12 bg-white border shadow-lg'>
            <button class='absolute top-14 right-10' @click='closeMenu' type="button">
            ...
            <ButtonLink class='text-highlight-red' text='Личный кабинет' type='button' @click='showLogin' />
            <ButtonLink class='text-highlight-red' text='Каталог услуг' type='button' />
            <ButtonLink class='text-highlight-red' text='Онлайн помощник' type='button' />
        </div>
    </div>
</template>
